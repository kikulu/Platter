...
| 📦 Staged prompt bundles            | Bundles can split their steps into stages (e.g. "Plan → Write → Submit"); "Copy this stage" copies every prompt in a stage to paste into one AI conversation. Ships with 5 staged bundle templates (academic writing, research proposal, software project, medical-device software compliance, recurring project communication) |
...
4. Save prompts you use often into the "Knowledge Base" so you can copy
   ...
   research proposal, running a project...) use a "Bundle": 5 staged
   bundles are built in, and in the bundle editor you can add stage
...
│   ├── default-knowledge-base.json # 41 built-in prompt templates (25 general + 16 role-based) + 5 staged bundle templates
