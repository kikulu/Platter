...
const { PLATFORM_URLS, SIDEBAR_WIDTH_EXPANDED, SIDEBAR_WIDTH_COLLAPSED } = require('./constants');
...
function createAccountView(account) {
  ...
  state.accountViews.set(account.id, { view, platform: account.platform, name: account.name });
}
