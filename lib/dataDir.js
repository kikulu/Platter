...
// 使用者自己另存的專案範本（內建範本放在 extractors/default-project-templates.json，
// 唯讀、隨程式版本更新，不會複製進資料目錄）。
function projectTemplatesPath() {
  return path.join(getDataDir(), 'project-templates.json');
}
